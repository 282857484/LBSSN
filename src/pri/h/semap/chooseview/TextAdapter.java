...
//		selectedDrawble = mContext.getResources().getDrawable(sId);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		TextView view;
		if (convertView == null) {
			view = (TextView) LayoutInflater.from(mContext).inflate(R.layout.h_choose_item, parent, false);
		} else {
...
//			view.setBackgroundResource(mContext.getResources().getDrawable(normalDrawbleId));//设置未选中状态背景图片
