...
//
//public class myMap12_19 extends Activity implements CloudListener {
//
...
//		myMessenger = new Messenger(myHandler);
//		// 初始化云管理器
//		CloudManager.getInstance().init(myMap12_19.this);
//
//		// 设置内容
...
//				// TODO Auto-generated method stub
//				Toast.makeText(myMap12_19.this, "正在保存中...", Toast.LENGTH_SHORT)
//						.show();
...
//
//		// 初始化定位信息
//		SEMapApplication.initLocationInfo(myMap12_19.this, locationdata,
//				locationlistener);
//
//		/**
//		 * 左右下角按钮设置
...
//							Toast.makeText(myMap12_19.this, searchinfo.location,
...
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				Intent intent = new Intent(myMap12_19.this, OfflineDemo.class);
...
//		final MyDialog dialog = new MyDialog(myMap12_19.this, R.style.z_myDialog);
...
//				Intent intent = new Intent(myMap12_19.this, BuildActivity.class);
//				startActivity(intent);
//
//				dialog.dismiss();
//				// finish();
...
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				Intent intent = new Intent(myMap12_19.this, ShareMoment.class);
//				startActivity(intent);
//				dialog.dismiss();
//				// finish();
//				overridePendingTransition(R.anim.z_push_left_in,
...
//
//				CloudManager.getInstance().nearbySearch(searchinfo);
//				Toast.makeText(myMap12_19.this, viewMiddle.getTags(tagsX, tagsY),
//						Toast.LENGTH_LONG).show();
//			}
//		});
//	}
...
//						if (error != 0) {
//							Toast.makeText(myMap12_19.this, "抱歉，未找到结果",
//									Toast.LENGTH_SHORT).show();
//						} else {
//							Toast.makeText(myMap12_19.this, "成功，查看详情页面",
//									Toast.LENGTH_SHORT).show();
//						}
//					}
//
...
//						if (error != 0) {
//							Toast.makeText(myMap12_19.this, "错误号：" + error,
//									Toast.LENGTH_LONG).show();
...
//						clearOverlay(mapview);
//						searchType = 0;
//						routeOverlay = new RouteOverlay(myMap12_19.this, mapview);
//						// 此处仅展示一个方案作为示例
...
//						}
//						if (error != 0 || res == null) {
//							Toast.makeText(myMap12_19.this,
//									"抱歉，未找到结果-错误号 ： " + error,
//									Toast.LENGTH_SHORT).show();
//							return;
//						}
...
//
//						searchType = 1;
//						transitOverlay = new TransitOverlay(myMap12_19.this, mapview);
//						// 此处仅展示一个方案作为示例
...
//
//				if (pri.h.semap.myMap12_19.pop != null) {
//					pri.h.semap.myMap12_19.pop.hidePop();
//					mapview.removeView(pri.h.semap.myMap12_19.contentbutton);
//
//				}
//
//				if (mark == 4) {
...
//						out.close();
//					}
//					Toast.makeText(myMap12_19.this, "截图保存在: " + file.toString(),
//							Toast.LENGTH_LONG).show();
...
//		if (head == null) {
//			isLongClick = true;
//			pri.h.semap.myMap12_19.mapsearch.reverseGeocode(currentpoint);
//		} else {
...
//							.toString());
//				} else {
//					Toast.makeText(myMap12_19.this, "请输入", Toast.LENGTH_LONG).show();
//				}
//
//			}
//
...
//			@Override
//			public void onClick(View v) {
//				Intent intent = new Intent(myMap12_19.this, showWayPlanDetail.class);
...
//				IndexNow = 0;
//			}
//			Toast.makeText(myMap12_19.this, "抱歉,未找到相关信息", Toast.LENGTH_LONG).show();
//		}
//
//	}
//
...
////						+ "15273131134.png";
////				Drawable drawable0 = ImageManagerMap.from(getBaseContext()).displayImage(url0, resId0);
//				
////				activityPOI = new activityOverlay(drawable0, mapview, myMap.this);
//				activityPOI = new activityOverlay(getResources().getDrawable(
//						R.drawable.h_real_aplaca), mapview, myMap12_19.this);
//				
...
////						+ addressInfo.visitFolderUserHeadXiaotu + "/"
////						+ "15273131134.png";
////				Drawable drawable2 = ImageManagerMap.from(getBaseContext()).displayImage(url2, resId2);
////				
////				messagePOI = new messageOverlay(drawable2, mapview, myMap.this);
