...
//import pri.w.mtag.ShareMoment;
//import pri.z.show.BuildActitityOrMoment;
...
//
//public class myMap9_3 extends Activity implements CloudListener {
//
...
//		myMessenger = new Messenger(myHandler);
//		// 初始化云管理器
//		CloudManager.getInstance().init(myMap9_3.this);
//
//		// 设置内容
...
//				// TODO Auto-generated method stub
//				Toast.makeText(myMap9_3.this, "正在保存中...", Toast.LENGTH_SHORT)
//						.show();
...
//
//		// 初始化定位信息
//		SEMapApplication.initLocationInfo(myMap9_3.this, locationdata,
//				locationlistener);
//
//		/**
//		 * 左右下角按钮设置
//		 */
//		MyAnimations.initOffset(myMap9_3.this);
//		initialLeftButton();
//		// initialRightButton();
//
...
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				Intent intent = new Intent(myMap9_3.this, OfflineDemo.class);
...
//		Builder builder = new Builder(myMap9_3.this);
//
//		builder.setTitle("选择类型");
//		LinearLayout li = new LinearLayout(myMap9_3.this);
//		li.setOrientation(1);
//		Button btnBuildActivity = new Button(myMap9_3.this);
//		Button btnBuildMoment = new Button(myMap9_3.this);
//		btnBuildActivity.setText("发起活动");
//		btnBuildMoment.setText("发起动态");
//		btnBuildActivity.setTextColor(Color.WHITE);
//		btnBuildMoment.setTextColor(Color.WHITE);
//		li.addView(btnBuildActivity);
//		li.addView(btnBuildMoment);
//		builder.setView(li);
...
//				// TODO Auto-generated method stub
//				Toast.makeText(getBaseContext(), "正在创建活动。。。", 1).show();
//				Intent intent = new Intent(myMap9_3.this,
//						ShareMoment.class);
//				startActivity(intent);
//				dialog.dismiss();
//			}
...
//		final AlertDialog dialog = new AlertDialog.Builder(myMap9_3.this)
//		// .setIcon(R.drawable.s_ljlogo)
//		// .setTitle("路径规划")
//				.setView(wayplanForm).create();
//		dialog.show();
...
//			}
//
//			private void SearchButtonProcess(int typesearch) {
...
//					mapsearch.drivingSearch(currentcity.getText().toString(),
//							startNode, currentcity.getText().toString(),
//							endNode);
//				} else if (checkedRadioButtonId == R.id.h_transitsearch) {
//					mapsearch.transitSearch(currentcity.getText().toString(),
//							startNode, endNode);
//				} else if (checkedRadioButtonId == R.id.h_walksearch) {
//					mapsearch.walkingSearch(currentcity.getText().toString(),
//							startNode, currentcity.getText().toString(),
//							endNode);
//				}
//			}
...
//						 * 截取当前地图
//						 */
//						Toast.makeText(myMap9_3.this, "正在保存中...",
...
//						 * 更新当前地图
//						 */
//						Toast.makeText(myMap9_3.this, "刷新地图界面...",
...
//						new AlertDialog.Builder(myMap9_3.this)
...
//		// TODO Auto-generated method stub
//		ImageManager2.from(myMap9_3.this).displayImage(myselfImage,
...
//
//				PieMenu.addMenuEntry(new PersonInfo(myMap9_3.this));
//				PieMenu.addMenuEntry(new Configure(myMap9_3.this));
...
//			}
//			Toast.makeText(myMap9_3.this, "将使用系统起终点图标", Toast.LENGTH_SHORT).show();
//		} else {
//			if (routeOverlay != null) {
...
//						R.drawable.icon_en));
//			}
//			Toast.makeText(myMap9_3.this, "将使用自定义起终点图标", Toast.LENGTH_SHORT)
//					.show();
//		}
...
//				Toast.makeText(myMap9_3.this, viewMiddle.getTags(tagsX, tagsY),
//						Toast.LENGTH_LONG).show();
//			}
//		});
//	}
...
//						if (error != 0) {
//							Toast.makeText(myMap9_3.this, "抱歉，未找到结果",
//									Toast.LENGTH_SHORT).show();
//						} else {
//							Toast.makeText(myMap9_3.this, "成功，查看详情页面",
//									Toast.LENGTH_SHORT).show();
//						}
//					}
//
...
//						if (error != 0) {
//							Toast.makeText(myMap9_3.this, "错误号：" + error,
//									Toast.LENGTH_LONG).show();
...
//									myMap9_3.this, mapview, mapsearch);
...
//							return;
//						}
//						Toast.makeText(myMap9_3.this, "结果", Toast.LENGTH_SHORT)
//								.show();
//
//						clearOverlay(mapview);
//						searchType = 0;
//						routeOverlay = new RouteOverlay(myMap9_3.this, mapview);
//						// 此处仅展示一个方案作为示例
...
//
//						searchType = 1;
//						transitOverlay = new TransitOverlay(myMap9_3.this, mapview);
//						// 此处仅展示一个方案作为示例
...
//				// TODO Auto-generated method stub
//				Toast.makeText(myMap9_3.this, "地图加载对象完成", Toast.LENGTH_SHORT)
//						.show();
//				if (mark == 2) {
//					CloudPoiInfo cpi = SEMapApplication.getInstance().transferObj
//							.getRoutePlanPoiInfo();
...
//								.getDrawable(R.drawable.h_aplaca), mapview,
//								myMap9_3.this);
...
//	// }
//
//	private void addChoiceActivityBuildPlace(String head) {
//		// TODO Auto-generated method stub
//		int xLayoutSize = whatisthislayout.getWidth();
//		int yLayoutSize = whatisthislayout.getHeight();
//		PieMenu = new RadialMenuWidget(getBaseContext());
...
//		if (head == null) {
//			isLongClick = true;
//			pri.h.semap.myMap9_3.mapsearch.reverseGeocode(currentpoint);
//		} else {
...
//
//		PieMenu.setCenterCircle(new Close());
//		PieMenu.addMenuEntry(new choiceRight(myMap9_3.this));
//		PieMenu.addMenuEntry(new choiceCancel(myMap9_3.this));
//		// PieMenu.addMenuEntry(new SearchFreeInformation(myMap.this));
//
//		whatisthislayout.addView(PieMenu);
//	}
...
//
//		PieMenu.setCenterCircle(new Close());
//		PieMenu.addMenuEntry(new placeRadialMenuEntryRouteSearch(myMap9_3.this));
//		PieMenu.addMenuEntry(new SearchPOISomething(myMap9_3.this));
//		PieMenu.addMenuEntry(new ShareLocationInfo(myMap9_3.this));
//		PieMenu.addMenuEntry(new BuildSomething(myMap9_3.this));
//		// PieMenu.addMenuEntry(new SearchFreeInformation(myMap.this));
//
//		whatisthislayout.addView(PieMenu);
//	}
...
//			@Override
//			public void onClick(View v) {
//				Intent intent = new Intent(myMap9_3.this, showWayPlanDetail.class);
...
//				return;
//			}
//			Log.e("onReceiveLocation", "get locationpoint:"
...
//
//			PieMenu.setCenterCircle(new Close());
//			PieMenu.addMenuEntry(new StartBoardcase(myMap9_3.this));
//			PieMenu.addMenuEntry(new MyLocationNote(myMap9_3.this));
//
//			whatisthislayout.addView(PieMenu);
//			return true;
//		}
...
//		if (pop != null) {
//			pop.hidePop();
//			mapview.removeView(pri.h.semap.myMap9_3.contentbutton);
//		}
//		// if (mypop != null) {
//		// mypop.hidePop();
//		// }
...
//		} else {
//			Toast.makeText(myMap9_3.this, "抱歉,未找到相关信息", Toast.LENGTH_LONG).show();
//		}
//
//	}
//
...
//						.getDrawable(R.drawable.h_aplaca), mapview, myMap9_3.this);
...
//						R.drawable.h_aplaca), mapview, myMap9_3.this);
