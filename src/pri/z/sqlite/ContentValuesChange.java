 ...
 * @author 祝侦科 2014-3-8
 */
public class ContentValuesChange {
	// private DBAdapter(){}

	public static final String DB_NAME = "letsparty2014.db";// 数据库名称
	public static final String Activity_Table = "activitybase";
	public static final String UserInfo_Table = "userinfobase";
	public static final String Moment_Table = "momentbaseinfo";
	public static final String Grade_Table = "grade";
	// public static final String DiscussMoment_Table = "discussmoment";
	public static final String SearchDistance_Table = "searchdistance";
	public static final String PushMessage_Table = "pushmessage";
	public static final String RelationActivity_Table = "relationactivity";
	public static final String FeedBack_Table = "feedback";

	public static final int DB_VERSION = 7;// 当前数据库的版本号
	...
	public static final String Key_MomentMessageId = "MomentMessageId";
	...
	// private static final String Key_DiscussMessageId =
	// "DiscussMessageId";//用户评论的动态Id
	// private static final String Key_DiscussUserId = "DiscussUserId"
	// ;//该评论的用户Id
	// private static final String Key_DiscussUserName =
	// "DiscussUserName";//该评论的用户昵称
	// private static final String Key_DiscussPointId = "DiscussPointId";//指向Id
	// private static final String Key_DiscussUploadTime =
	// "DiscussUploadTime";//发表时间
	// private static final String Key_DiscussContent = "DiscussContent";//评论内容

	// 搜索范围的字段
	public static final String Key_SearchDistanceId = "DistanceId";// 数据库中自增长的数据
	...
	public static final String Key_PushID = "PushID";// 推送得到消息ID
	...
	public static final String Key_RelationActivityID = "RelationActivityID";// 活动ID
	...
	public static final String Key_RelationActivityStatus = "RelationActivityStatus";// 用户与活动的关系：(-1.用户主办;1.用户参加;2.用申请;3.活动方邀请;4.用户关注;5.未审核通过;6.被踢出用户)
	...
	public ContentValuesChange(Context _context) {
		context = _context;
	}

	public static ContentValuesChange dbAdapter = null;
	...
	public int updateOneActivityByID(ActivitySelectData base) {
		...
		newValues.put(Key_ActivityMaxMemberNumber,
				base.getActivityMaxMemberNumber());
		...
		return db.update(Activity_Table, newValues, Key_ActivityID + "=? ",
				new String[] { base.getActivityID() + "" });
	}

	public static ContentValues contentUpdateOneActivityByID(
			ActivitySelectData base) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_ActivityDBID, base.getActivityID());
		newValues.put(Key_ActivityID, base.getActivityID());
	...
	public int updateOneMomentByMessageId(int messageId, String PraiseNum,
			String CriticizenNum, String HasOrNo) {
		ContentValues newValues = new ContentValues();
		...
		return db.update(Moment_Table, newValues, Key_MomentMessageId + "=? ",
				new String[] { String.valueOf(messageId) });
	}

	public static ContentValues contentUpdateOneMomentByMessageId(
			String PraiseNum, String CriticizenNum, String HasOrNo) {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_MomentPraiseNum, PraiseNum);
		newValues.put(Key_MomentCritizenNum, CriticizenNum);
		newValues.put(Key_MomentHasOrNo, HasOrNo);
	...
	public int updateOneSearchDistance(SearchDistance myDistanceUpdate) {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_SearchDistanceActivityDis,
				myDistanceUpdate.DistanceActivityDis);
		newValues.put(Key_SearchDistanceMomentDis,
				myDistanceUpdate.DistanceMomentDis);

		return db.update(SearchDistance_Table, newValues, Key_SearchDistanceId
				+ "=? ",
				new String[] { String.valueOf(myDistanceUpdate.DistanceId) });
	}

	public static ContentValues contentUpdateOneSearchDistance(
	...
	public int updateOneMomentByMessageId(MomentBaseInfo info) {
		...
		return db.update(Moment_Table, newValues, Key_MomentMessageId + "=? ",
				new String[] { String.valueOf(info.MessageId) });
	}
	...
	public int updateOnePushMessageByPushId(String pushId) {
		...
		return db.update(PushMessage_Table, newValues, Key_PushID + "=? ",
				new String[] { pushId });
	}
	...
	/** 改变是否已读的状态 **/
	public static ContentValues contentUpdateAllPushMessageByPushId() {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_PushStatue, "2");// 标记为已读
	...
	public int updateOneRelationActivityStart(String ActivityId) {
		...
		return db.update(RelationActivity_Table, newValues,
				Key_RelationActivityID + "=? ", new String[] { ActivityId });
	}

	public static ContentValues contentUpdateOneRelationActivityStart() {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_RelationActivityStartNotifyFlag, "2");// 标记为已读
	...
	public static ContentValues contentUpdateOneRelationActivityStatue(
			String statue) {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_RelationActivityStatus, statue);// 更新状态
	...
	public static ContentValues contentUpdateOneRelationActivityEnd() {
		ContentValues newValues = new ContentValues();
		newValues.put(Key_RelationActivityEndNotifyFlag, "2");// 标记为已读
	...
	public int updateOneUserInfoByID(String phone, UserInfoSelectData info) {
		...
		return db.update(UserInfo_Table, newValues, Key_UserPhone + "=? ",
				new String[] { phone });
	}
	...
	public static ContentValues contentInsertActivityBase(
			ActivitySelectData base) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_ActivityDBID, base.ActivityID);
	...
	public static ContentValues contentInsertUserInfoBase(
			UserInfoSelectData info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_UserID, info.UserID);
		newValues.put(Key_UserName, info.getUserName());
	...
	public static ContentValues contentInsertMomentBaseInfo(MomentBaseInfo info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_MomentId, info.MomentId);
		newValues.put(Key_MomentMessageId, info.MessageId);
	...
	public static ContentValues contentInsertGradeInfo(GradeInfo info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		newValues.put(Key_GradePhone, info.getGradePhone());
		newValues.put(Key_GradeActId, info.getGradeActId());
	...
	public long insertRelationActivity(RelationActivity info) {
		...
		newValues.put(Key_RelationActivityBuilderUserID,
				info.RelationActivityBuilderUserID);
		newValues.put(Key_RelationActivityStartTime,
				info.RelationActivityStartTime);
		newValues
				.put(Key_RelationActivityEndTime, info.RelationActivityEndTime);
		newValues.put(Key_RelationActivityStartNotifyFlag,
				info.RelationActivityStartNotifyFlag);
		newValues.put(Key_RelationActivityEndNotifyFlag,
				info.RelationActivityEndNotifyFlag);
	...
	public static ContentValues contentInsertRelationActivity(
			RelationActivity info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_RelationActivityDBID, info.RelationActivityDBID);
		newValues.put(Key_RelationUserID, info.RelationUserID);
	...
	public static ContentValues contentInsertSearchDistance(SearchDistance info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_SearchDistanceId, info.DistanceId);
		newValues.put(Key_SearchDistanceMomentDis, info.DistanceMomentDis);
	...
	public static ContentValues contentInsertPushMessage(PushMessage info) {
		ContentValues newValues = new ContentValues();
		// ID为自增长的不要添加
		// newValues.put(Key_PushDBID, info.PushDBID);
		newValues.put(Key_PushID, info.PushID);
	...
	public ActivitySelectData[] queryAllActivityBases() {
		Cursor results = db.query(Activity_Table, new String[] {
				Key_ActivityID, Key_BuildActivityUserID, Key_ActivityManagerID,
				Key_UploadTime, Key_IsDirectJoinIn, Key_ActivityFlag,
				Key_ActivityMemberNumber, Key_ActivityMaxMemberNumber,
				Key_ActivityDescribe, Key_ActivityName, Key_ActivityStartTime,
				Key_ActivityEndTime, Key_ActivityHoldPlace, Key_HelpPhone,
				Key_ActivityBelongClass, Key_ActivityTags, Key_ActivityOpinion,
				Key_ActivityAddress, Key_ActivityLogo }, null, null, null,
				null, null);
	...
	public ActivitySelectData[] queryAllActivityBasesAfterNow() {
		Cursor results = db.query(Activity_Table, new String[] {
				...
				Key_ActivityEndTime, Key_ActivityHoldPlace, Key_HelpPhone,
				Key_ActivityBelongClass, Key_ActivityTags, Key_ActivityOpinion,
				Key_ActivityAddress, Key_ActivityLogo }, Key_ActivityStartTime
				+ ">=? ", new String[] { FormatTime.getFormatTime() }, null,
				null, null);
		return ConvertToActivitySelectDatas(results);
	}

	public static String[] contentQueryAllActivityBasesAfterNow() {
		String[] strs = new String[] { Key_ActivityID, Key_BuildActivityUserID,
				Key_ActivityManagerID, Key_UploadTime, Key_IsDirectJoinIn,
				Key_ActivityFlag, Key_ActivityMemberNumber,
				Key_ActivityMaxMemberNumber, Key_ActivityDescribe,
				Key_ActivityName, Key_ActivityStartTime, Key_ActivityEndTime,
				Key_ActivityHoldPlace, Key_HelpPhone, Key_ActivityBelongClass,
				Key_ActivityTags, Key_ActivityOpinion, Key_ActivityAddress,
				Key_ActivityLogo };
		return strs;
	}
	...
	public ActivitySelectData[] queryTopTenActivityBases() {
		Cursor results = db.query(Activity_Table, new String[] {
				...
				Key_ActivityBelongClass, Key_ActivityTags, Key_ActivityOpinion,
				Key_ActivityAddress, Key_ActivityLogo }, null, null, null,
				null, null, String.valueOf(10));
		return ConvertToActivitySelectDatas(results);
	}

	public MomentBaseInfo[] queryAllMomentBaseInfo() {
		Cursor results = db.query(Moment_Table, new String[] { Key_MomentId,
				Key_MomentMessageId, Key_MomentUserId, Key_MomentUserName,
				Key_MomentUploadTime, Key_MomentContent, Key_MomentPraiseNum,
				Key_MomentCritizenNum, Key_MomentMyUserId,
				Key_MomentMyUserName, Key_MomentHasOrNo, Key_MomentLocation,
				Key_MomentSex, Key_MomentAge, Key_MomentShowPhotos }, null,
				null, null, null, null);
	...
	public static String[] contentQueryAllMomentBaseInfoTop10() {
		String[] strs = new String[] { Key_MomentId, Key_MomentMessageId,
				Key_MomentUserId, Key_MomentUserName, Key_MomentUploadTime,
				Key_MomentContent, Key_MomentPraiseNum, Key_MomentCritizenNum,
				Key_MomentMyUserId, Key_MomentMyUserName, Key_MomentHasOrNo,
				Key_MomentLocation, Key_MomentSex, Key_MomentAge,
				Key_MomentShowPhotos };
		return strs;
	}

	public UserInfoSelectData[] queryOneUserInfoBase(String phone) {
		Cursor results = db.query(UserInfo_Table, new String[] { Key_UserID,
				Key_UserName, Key_UserUploadTime, Key_Code, Key_UserPhone,
				Key_UserJoinActivity, Key_UserAttentionClass, Key_UserQQ,
				Key_UserWeiChat, Key_UserTags, Key_UserClass, Key_UserDescribe,
				Key_UserLevel, Key_UserLogo, Key_UserAge, Key_UserSex,
				Key_UserSchool, Key_UserProfession, Key_UserBirthday,
				Key_UserHome }, Key_UserPhone + "=? ", new String[] { phone },
				null, null, null);
	...
	public MomentBaseInfo[] queryOneMomentBaseInfo(String messageId) {
		Cursor results = db.query(Moment_Table, new String[] { Key_MomentId,
				...
				Key_MomentCritizenNum, Key_MomentMyUserId,
				Key_MomentMyUserName, Key_MomentHasOrNo, Key_MomentLocation,
				Key_MomentSex, Key_MomentAge, Key_MomentShowPhotos },
				Key_MomentMessageId + "=? ", new String[] { messageId }, null,
				null, null);
		return ConvertToMomentBaseInfo(results);
	}
	...
	// Key_DiscussMessageId +"=? ", new
	// String[]{String.valueOf(discussMessageId)}, null, null, null);
	// return ConvertToDiscussMoments(results);
	// }

	public RelationActivity[] queryOneRelationActivityInfo(String ActivityID) {
		Cursor results = db.query(RelationActivity_Table,
				new String[] { Key_RelationActivityDBID, Key_RelationUserID,
						Key_RelationActivityID, Key_RelationActivityName,
						Key_RelationActivityBuilderUserID,
						Key_RelationActivityStartTime,
						Key_RelationActivityEndTime,
						Key_RelationActivityStartNotifyFlag,
						Key_RelationActivityEndNotifyFlag,
						Key_RelationActivityStatus }, Key_RelationActivityID
	...
	public PushMessage[] queryOnePushMessageInfo(String pushId) {
		Cursor results = db.query(PushMessage_Table, new String[] {
				Key_PushDBID, Key_PushID, Key_PushUserID, Key_PushMessage,
				Key_PushStatue }, Key_PushID + "=? ", new String[] { pushId },
				null, null, null, null);
	...
	public UserInfoSelectData[] queryAllUserInfoBases() {
		Cursor results = db.query(UserInfo_Table, new String[] { Key_UserID,
				...
				Key_UserLevel, Key_UserLogo, Key_UserAge, Key_UserSex,
				Key_UserSchool, Key_UserProfession, Key_UserBirthday,
				Key_UserHome }, null, null, null, null, null);
		return ConvertToUserInfoSelectDatas(results);
	}

	public static String[] contentQueryAllUserInfoBases() {
		String[] strs = new String[] { Key_UserID, Key_UserName,
				Key_UserUploadTime, Key_Code, Key_UserPhone,
				Key_UserJoinActivity, Key_UserAttentionClass, Key_UserQQ,
				Key_UserWeiChat, Key_UserTags, Key_UserClass, Key_UserDescribe,
				Key_UserLevel, Key_UserLogo, Key_UserAge, Key_UserSex,
				Key_UserSchool, Key_UserProfession, Key_UserBirthday,
	...
	public GradeInfo[] queryAllGradeInfos() {
		Cursor results = db.query(Grade_Table, new String[] { Key_GradeId,
				Key_GradePhone, Key_GradeActId, Key_GradeNum, Key_GradeTime },
	...
	public FeedBackInfo[] queryAllFeedBackInfos() {
		Cursor results = db.query(FeedBack_Table, new String[] {
				Key_FeedBackDBID, Key_FeedBackUserId, Key_FeedBackContent,
				Key_FeedBackTime }, null, null, null, null, null);
	...
	public GradeInfo[] queryOneGradeInfos(String ActivityID) {
		Cursor results = db.query(Grade_Table, new String[] { Key_GradeId,
				Key_GradePhone, Key_GradeActId, Key_GradeNum, Key_GradeTime },
				Key_GradeActId + "=?", new String[] { ActivityID }, null, null,
				null);
		return ConvertToGradeInfos(results);
	}
	...
	public RelationActivity[] queryAllRelationActivitys() {
		Cursor results = db.query(RelationActivity_Table,
				new String[] { Key_RelationActivityDBID, Key_RelationUserID,
						...
						Key_RelationActivityStartNotifyFlag,
						Key_RelationActivityEndNotifyFlag,
						Key_RelationActivityStatus }, null, null, null, null,
				null);
		return ConvertToRelationActivitys(results);
	}

	public static String[] contentQueryAllRelationActivitys() {
		String[] strs = new String[] { Key_RelationActivityDBID,
				Key_RelationUserID, Key_RelationActivityID,
				Key_RelationActivityName, Key_RelationActivityBuilderUserID,
				Key_RelationActivityStartTime, Key_RelationActivityEndTime,
				Key_RelationActivityStartNotifyFlag,
				Key_RelationActivityEndNotifyFlag, Key_RelationActivityStatus };
		return strs;
	}
	...
	public RelationActivity[] queryAllMyHostRelationActivitys() {
		Cursor results = db.query(RelationActivity_Table,
				...
				Key_RelationActivityStatus + "=?", new String[] { "-1" }, null,
				null, null, null);
		return ConvertToRelationActivitys(results);
	}
	...
	public SearchDistance[] queryAllSearchDistances() {
		Cursor results = db.query(SearchDistance_Table, new String[] {
				...
				Key_SearchDistanceActivityDis }, null, null, null, null, null);
		return ConvertToSearchDistances(results);
	}

	public static String[] contentQueryAllSearchDistances() {
		String[] strs = new String[] { Key_SearchDistanceId,
				Key_SearchDistanceMomentDis, Key_SearchDistanceActivityDis };
		return strs;
	}
	...
	public PushMessage[] queryAllPushMessages() {
		Cursor results = db.query(PushMessage_Table, new String[] {
				Key_PushDBID, Key_PushID, Key_PushUserID, Key_PushMessage,
				Key_PushStatue }, null, null, null, null, null);
		return ConvertToPushMessages(results);
	}

	public static String[] contentQueryAllPushMessages() {
		String[] strs = new String[] { Key_PushDBID, Key_PushID,
				Key_PushUserID, Key_PushMessage, Key_PushStatue };
		return strs;
	}
	...
	public boolean judgeIfExistInMomentBase(String messageId) {
		...
		if (results != null && results.getCount() > 0) {
			// Log.v("哈哈哈哈",
			// "-----results.getCount()-------"+results.getCount()+"----------messageId-----"+messageId);
			flag = true;
		}
		results.close();
		return flag;
	...
	public static ActivitySelectData[] ConvertToActivitySelectDatas(
			Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		...
		for (int i = 0; i < resultCounts; i++) {
			// 取值
			String StractivityID = cursor.getString(cursor
					.getColumnIndex(Key_ActivityID));
			long activityID = Long.valueOf(StractivityID);
			String StrbuildActivityUserID = cursor.getString(cursor
					.getColumnIndex(Key_BuildActivityUserID));
			long buildActivityUserID = Long.valueOf(StrbuildActivityUserID);
			String StractivityManagerID = cursor.getString(cursor
					.getColumnIndex(Key_ActivityManagerID));
			long activityManagerID = Long.valueOf(StractivityManagerID);

			String uploadTime = cursor.getString(cursor
					.getColumnIndex(Key_UploadTime));
			String isDirectJoinIn = cursor.getString(cursor
					.getColumnIndex(Key_IsDirectJoinIn));
			String activityFlag = cursor.getString(cursor
					.getColumnIndex(Key_ActivityFlag));
			String activityMemberNumber = cursor.getString(cursor
					.getColumnIndex(Key_ActivityMemberNumber));
			String activityMaxMemberNumber = cursor.getString(cursor
					.getColumnIndex(Key_ActivityMaxMemberNumber));
			String activityDescribe = cursor.getString(cursor
					.getColumnIndex(Key_ActivityDescribe));
			String activityName = cursor.getString(cursor
					.getColumnIndex(Key_ActivityName));
			String activityStartTime = cursor.getString(cursor
					.getColumnIndex(Key_ActivityStartTime));
			String activityEndTime = cursor.getString(cursor
					.getColumnIndex(Key_ActivityEndTime));
			String activityHoldPlace = cursor.getString(cursor
					.getColumnIndex(Key_ActivityHoldPlace));
			String helpPhone = cursor.getString(cursor
					.getColumnIndex(Key_HelpPhone));
			String activityBelongClass = cursor.getString(cursor
					.getColumnIndex(Key_ActivityBelongClass));
			String activityTags = cursor.getString(cursor
					.getColumnIndex(Key_ActivityTags));
			String activityOpinion = cursor.getString(cursor
					.getColumnIndex(Key_ActivityOpinion));
			String activityAddress = cursor.getString(cursor
					.getColumnIndex(Key_ActivityAddress));
			String activityLogo = cursor.getString(cursor
					.getColumnIndex(Key_ActivityLogo));
			// 赋值
			bases[i] = new ActivitySelectData(activityID, buildActivityUserID,
					activityManagerID, uploadTime, isDirectJoinIn,
					activityFlag, activityMemberNumber,
					activityMaxMemberNumber, activityDescribe, activityName,
					activityStartTime, activityEndTime, activityHoldPlace,
					helpPhone, activityBelongClass, activityTags,
					activityOpinion, activityAddress, activityLogo);
			cursor.moveToNext();
		}
		cursor.close();
		return bases;
	...
	public static UserInfoSelectData[] ConvertToUserInfoSelectDatas(
			Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		...
		for (int i = 0; i < resultCounts; i++) {
			...
			String uploadTime = cursor.getString(cursor
					.getColumnIndex(Key_UserUploadTime));
			String code = cursor.getString(cursor.getColumnIndex(Key_Code));
			String userPhone = cursor.getString(cursor
					.getColumnIndex(Key_UserPhone));
			String userJoinActivity = cursor.getString(cursor
					.getColumnIndex(Key_UserJoinActivity));
			String userAttentionClass = cursor.getString(cursor
					.getColumnIndex(Key_UserAttentionClass));
			String userQQ = cursor.getString(cursor.getColumnIndex(Key_UserQQ));
			String userWeiChat = cursor.getString(cursor
					.getColumnIndex(Key_UserWeiChat));
			String userTags = cursor.getString(cursor
					.getColumnIndex(Key_UserTags));
			String userClass = cursor.getString(cursor
					.getColumnIndex(Key_UserClass));
			String userDescribe = cursor.getString(cursor
					.getColumnIndex(Key_UserDescribe));
			String userLevel = cursor.getString(cursor
					.getColumnIndex(Key_UserLevel));
			String userLogo = cursor.getString(cursor
					.getColumnIndex(Key_UserLogo));
			String userAge = cursor.getString(cursor
					.getColumnIndex(Key_UserAge));
			String userSex = cursor.getString(cursor
					.getColumnIndex(Key_UserSex));
			String school = cursor.getString(cursor
					.getColumnIndex(Key_UserSchool));
			String profession = cursor.getString(cursor
					.getColumnIndex(Key_UserProfession));
			String birthday = cursor.getString(cursor
					.getColumnIndex(Key_UserBirthday));
			...
			infos[i] = new UserInfoSelectData(userID, userName, uploadTime,
					...
					userLevel, userLogo, userAge, userSex, school, profession,
					birthday, home);
			cursor.moveToNext();
		}
		cursor.close();
	...
	private MomentBaseInfo[] ConvertToMomentBaseInfo(Cursor cursor) {
		...
		for (int i = 0; i < resultCounts; i++) {
			...
			String messageId = cursor.getString(cursor
					.getColumnIndex(Key_MomentMessageId));
			String userId = cursor.getString(cursor
					.getColumnIndex(Key_MomentUserId));
			String userName = cursor.getString(cursor
					.getColumnIndex(Key_MomentUserName));
			String uploadTime = cursor.getString(cursor
					.getColumnIndex(Key_MomentUploadTime));
			String momentContent = cursor.getString(cursor
					.getColumnIndex(Key_MomentContent));
			String praiseNum = cursor.getString(cursor
					.getColumnIndex(Key_MomentPraiseNum));
			String critizenNum = cursor.getString(cursor
					.getColumnIndex(Key_MomentCritizenNum));
			String myUserId = cursor.getString(cursor
					.getColumnIndex(Key_MomentMyUserId));
			String myUserName = cursor.getString(cursor
					.getColumnIndex(Key_MomentMyUserName));
			String hasOrNo = cursor.getString(cursor
					.getColumnIndex(Key_MomentHasOrNo));
			String location = cursor.getString(cursor
					.getColumnIndex(Key_MomentLocation));
			...
			String showPhotos = cursor.getString(cursor
					.getColumnIndex(Key_MomentShowPhotos));
			// 赋值
			infos[i] = new MomentBaseInfo(momentId, messageId, userId,
					userName, uploadTime, momentContent, praiseNum,
					critizenNum, myUserId, myUserName, hasOrNo, location, sex,
					age, showPhotos);
			cursor.moveToNext();
		}
		cursor.close();
	 ...
	 * @return
	 */
	public static MomentBaseInfo[] ConvertToMomentBaseInfoTop10(Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		int resultCounts = cursor.getCount();
		...
		if (resultCounts > 10) {
			...
			for (int i = resultCounts, index = 0; index < 10; i--, index++) {
				// 取值
				int momentId = cursor.getInt(cursor
						.getColumnIndex(Key_MomentId));
				String messageId = cursor.getString(cursor
						.getColumnIndex(Key_MomentMessageId));
				String userId = cursor.getString(cursor
						.getColumnIndex(Key_MomentUserId));
				...
				String sex = cursor.getString(cursor
						.getColumnIndex(Key_MomentSex));
				String age = cursor.getString(cursor
						.getColumnIndex(Key_MomentAge));
				String showPhotos = cursor.getString(cursor
						.getColumnIndex(Key_MomentShowPhotos));
				// 赋值
	 ...
	 * @return
	 */
	public static MomentBaseInfo[] ConvertToMomentBaseInfoAll(Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		int resultCounts = cursor.getCount();
		...
		MomentBaseInfo[] infos = new MomentBaseInfo[resultCounts];
		// i保存cursor的下标，index保存infos数组的下标
		for (int index = 0; index < resultCounts; index++) {
			// 取值
			int momentId = cursor.getInt(cursor.getColumnIndex(Key_MomentId));
			String messageId = cursor.getString(cursor
					.getColumnIndex(Key_MomentMessageId));
	...
	private GradeInfo[] ConvertToGradeInfos(Cursor cursor) {
		...
		for (int i = 0; i < resultCounts; i++) {
			...
			String GradePhone = cursor.getString(cursor
					.getColumnIndex(Key_GradePhone));
			String GradeActId = cursor.getString(cursor
					.getColumnIndex(Key_GradeActId));
			String GradeNum = cursor.getString(cursor
					.getColumnIndex(Key_GradeNum));
			String GradeTime = cursor.getString(cursor
					.getColumnIndex(Key_GradeTime));

			// 赋值
			infos[i] = new GradeInfo(GradeId, GradePhone, GradeActId, GradeNum,
					GradeTime);
			cursor.moveToNext();
		}
		cursor.close();
	...
	private FeedBackInfo[] ConvertToFeedBackInfos(Cursor cursor) {
		...
		for (int i = 0; i < resultCounts; i++) {
			// 取值
			int feedBackDBID = cursor.getInt(cursor
					.getColumnIndex(Key_FeedBackDBID));
			String feedBackUserId = cursor.getString(cursor
					.getColumnIndex(Key_FeedBackUserId));
			String feedBackContent = cursor.getString(cursor
					.getColumnIndex(Key_FeedBackContent));
			String feedBackTime = cursor.getString(cursor
					.getColumnIndex(Key_FeedBackTime));
	...
	// String discussUid =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussUid));
	// String discussMessageId =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussMessageId));
	// String discussUserId =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussUserId));
	// String discussUserName =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussUserName));
	// String discussPointId =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussPointId));
	// String discussUploadTime =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussUploadTime));
	// String discussContent =
	// cursor.getString(cursor.getColumnIndex(Key_DiscussContent));
	//
	// //赋值
	// infos[i] = new DiscussMoment(discussId, discussUid, discussMessageId,
	// discussUserId, discussUserName, discussPointId, discussUploadTime,
	// discussContent);
	// // Log.v("哈哈哈哈",
	// "-------手机数据库---DiscussMoment--------"+infos[i].toString());
	// cursor.moveToNext();
	// }
	// cursor.close();
	// return infos;
	...
	public static RelationActivity[] ConvertToRelationActivitys(Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		int resultCounts = cursor.getCount();
		...
		for (int i = 0; i < resultCounts; i++) {
			// 取值
			int relationActivityDBID = cursor.getInt(cursor
					.getColumnIndex(Key_RelationActivityDBID));
			String relationUserID = cursor.getString(cursor
					.getColumnIndex(Key_RelationUserID));
			String relationActivityID = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityID));
			String relationActivityName = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityName));
			String relationActivityBuilderUserID = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityBuilderUserID));
			String relationActivityStartTime = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityStartTime));
			String relationActivityEndTime = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityEndTime));
			String relationActivityStartNotifyFlag = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityStartNotifyFlag));
			String relationActivityEndNotifyFlag = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityEndNotifyFlag));
			String relationActivityStatus = cursor.getString(cursor
					.getColumnIndex(Key_RelationActivityStatus));
			// 赋值
			infos[i] = new RelationActivity(relationActivityDBID,
					relationUserID, relationActivityID, relationActivityName,
					relationActivityBuilderUserID, relationActivityStartTime,
					relationActivityEndTime, relationActivityStartNotifyFlag,
					relationActivityEndNotifyFlag, relationActivityStatus);
			cursor.moveToNext();
		}
		cursor.close();
		return infos;
	...
	public static SearchDistance[] ConvertToSearchDistances(Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		int resultCounts = cursor.getCount();
		...
		for (int i = 0; i < resultCounts; i++) {
			// 取值
			int distanceId = cursor.getInt(cursor
					.getColumnIndex(Key_SearchDistanceId));
			String distanceMomentDis = cursor.getString(cursor
					.getColumnIndex(Key_SearchDistanceMomentDis));
			String distanceActivityDis = cursor.getString(cursor
					.getColumnIndex(Key_SearchDistanceActivityDis));

			// 赋值
			infos[i] = new SearchDistance(distanceId, distanceMomentDis,
					distanceActivityDis);
			cursor.moveToNext();
		}
		// cursor.close();
	...
	public static PushMessage[] ConvertToPushMessages(Cursor cursor) {
		if (cursor == null) {
			return null;
		}
		int resultCounts = cursor.getCount();
		...
		for (int i = 0; i < resultCounts; i++) {
			...
			String pushUserID = cursor.getString(cursor
					.getColumnIndex(Key_PushUserID));
			String pushMessage = cursor.getString(cursor
					.getColumnIndex(Key_PushMessage));
			String pushStatue = cursor.getString(cursor
					.getColumnIndex(Key_PushStatue));
	...
	public long deleteOneActivity(int ActivityID) {
		return db.delete(Activity_Table, Key_ActivityID + "=?",
				new String[] { String.valueOf(ActivityID) });
	}

	public long deleteOneUserInfo(int UserID) {
		return db.delete(UserInfo_Table, Key_UserID + "=?",
				new String[] { String.valueOf(UserID) });
	}

	public long deleteOnePushMessage(String PushID) {
		return db.delete(PushMessage_Table, Key_PushID + "=?",
				new String[] { PushID });
	}

	public long deleteOneMomentBaseInfo(int messageId) {
		return db.delete(Moment_Table, Key_MomentMessageId + "=?",
				new String[] { String.valueOf(messageId) });
	}
	...
	public long deleteAllActivitysBeforeNow() {
		return db.delete(Activity_Table, Key_ActivityStartTime + "<=? ",
				new String[] { FormatTime.getFormatTime() });
	}
	...
	public long deleteUserHostRelationActivitys() {
		return db.delete(RelationActivity_Table, Key_RelationActivityStatus
				+ "=? ", new String[] { "-1" });
	}
	...
	public static class DBOpenHelper extends SQLiteOpenHelper {
		...
		private static final String Create_ActivityBase = "create table "
				+ Activity_Table + " (" + Key_ActivityDBID
				+ " integer primary key autoincrement, " + Key_ActivityID
				+ " varchar unique, " + Key_BuildActivityUserID + " varchar, "
				+ Key_ActivityManagerID + " varchar," + Key_UploadTime
				+ " varchar," + Key_IsDirectJoinIn + " varchar,"
				+ Key_ActivityFlag + " varchar," + Key_ActivityMemberNumber
				+ " varchar," + Key_ActivityMaxMemberNumber + " varchar,"
				+ Key_ActivityDescribe + " varchar," + Key_ActivityName
				+ " varchar," + Key_ActivityStartTime + " varchar,"
				+ Key_ActivityEndTime + " varchar," + Key_ActivityHoldPlace
				+ " varchar," + Key_HelpPhone + " varchar,"
				+ Key_ActivityBelongClass + " varchar," + Key_ActivityTags
				+ " varchar," + Key_ActivityOpinion + " varchar,"
				+ Key_ActivityAddress + " varchar," + Key_ActivityLogo
				+ " varchar);";
		private static final String Create_UserInfoBase = "create table "
				+ UserInfo_Table + " (" + Key_UserID
				+ " integer primary key autoincrement, " + Key_UserName
				+ " varchar," + Key_UserUploadTime + " varchar," + Key_Code
				+ " varchar," + Key_UserPhone + " varchar,"
				+ Key_UserJoinActivity + " varchar," + Key_UserAttentionClass
				+ " varchar," + Key_UserQQ + " varchar," + Key_UserWeiChat
				+ " varchar," + Key_UserTags + " varchar," + Key_UserClass
				+ " varchar," + Key_UserDescribe + " varchar," + Key_UserLevel
				+ " varchar," + Key_UserLogo + " varchar," + Key_UserAge
				+ " varchar," + Key_UserSex + " varchar," + Key_UserSchool
				+ " varchar," + Key_UserProfession + " varchar,"
				+ Key_UserBirthday + " varchar," + Key_UserHome + " varchar);";

		private static final String Create_MomentBaseInfo = "create table "
				+ Moment_Table + " (" + Key_MomentId
				+ " integer primary key autoincrement, " + Key_MomentMessageId
				+ " varchar unique," + Key_MomentUserId + " varchar,"
				+ Key_MomentUserName + " varchar," + Key_MomentUploadTime
				+ " varchar," + Key_MomentContent + " varchar,"
				+ Key_MomentPraiseNum + " varchar," + Key_MomentCritizenNum
				+ " varchar," + Key_MomentMyUserId + " varchar,"
				+ Key_MomentMyUserName + " varchar," + Key_MomentHasOrNo
				+ " varchar," + Key_MomentLocation + " varchar,"
				+ Key_MomentSex + " varchar," + Key_MomentAge + " varchar,"
				+ Key_MomentShowPhotos + " varchar);";

		private static final String Create_GradeInfo = "create table "
				+ Grade_Table + " (" + Key_GradeId
				+ " integer primary key autoincrement, " + Key_GradePhone
				+ " varchar," + Key_GradeActId + " varchar," + Key_GradeNum
				+ " varchar," + Key_GradeTime + " varchar);";

		// private static final String Create_DiscussMomentInfo= "create table "
		// +
		// DiscussMoment_Table + " (" + Key_DiscussId +
		// " integer primary key autoincrement, "
		// + Key_DiscussUid+ " varchar unique,"+ Key_DiscussMessageId+
		// " varchar,"+ Key_DiscussUserId+ " varchar,"
		// + Key_DiscussUserName+ " varchar,"+ Key_DiscussPointId+ " varchar,"+
		// Key_DiscussUploadTime+ " varchar,"
		// +Key_DiscussContent + " varchar);";

		private static final String Create_SearchDistanceInfo = "create table "
				+ SearchDistance_Table + " (" + Key_SearchDistanceId
				+ " integer primary key autoincrement, "
		...
		private static final String Create_PushMessageInfo = "create table "
				+ PushMessage_Table + " (" + Key_PushDBID
				+ " integer primary key autoincrement, " + Key_PushID
				+ " varchar unique," + Key_PushUserID + " varchar,"
				+ Key_PushMessage + " varchar," + Key_PushStatue + " varchar);";

		private static final String Create_RelationActivityInfo = "create table "
				+ RelationActivity_Table
				+ " ("
				+ Key_RelationActivityDBID
				+ " integer primary key autoincrement, "
				+ Key_RelationActivityID
				+ " varchar unique,"
				+ Key_RelationUserID
				+ " varchar,"
				+ Key_RelationActivityName
				+ " varchar,"
				+ Key_RelationActivityBuilderUserID
				+ " varchar,"
				+ Key_RelationActivityStartTime
		...
		private static final String Create_FeedBackInfo = "create table "
				+ FeedBack_Table + " (" + Key_FeedBackDBID
				+ " integer primary key autoincrement, " + Key_FeedBackUserId
				+ " varchar," + Key_FeedBackContent + " varchar,"
