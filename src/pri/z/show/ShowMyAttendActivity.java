 ...
 */
public class ShowMyAttendActivity extends Activity {
	...
	public void onCreate(Bundle bundle) {
		...
		setContentView(R.layout.z_showattendacvitity);
...
//		showMyHisActivity();
		...
		imgHasNoData = (ImageView) findViewById(R.id.z_myAttendActHasNoDataImg);
		relLoading = (RelativeLayout) findViewById(R.id.z_myAttendActivityLoadingRel);
		btnSync = (Button)findViewById(R.id.z_showAttendActivityTitleSync);
		btnSync.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(userid.equals("0")){
					LoginDialog.showLoginDialog(ShowMyAttendActivity.this);
					return;
				}
				if (!UtilsZZK.checkNetworkState(ShowMyAttendActivity.this)) {
					return;
				}
	 ...
	 * 
	 */
	private void showMyHisActivity(RelationActivity[] acts) {
		listView = (ListView) findViewById(R.id.z_myAttendActivityListView);
...
//		dbAdapter.close();
		...
		for (int index = 0; index < acts.length; index++) {
			if (acts[index].RelationActivityStatus.equals("1")
					|| acts[index].RelationActivityStatus.equals("3")) {
	...
	BaseAdapter adapter = new BaseAdapter() {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			vi.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					Intent intent = new Intent(ShowMyAttendActivity.this, ActivityLocal.class);
