...
public class DragGridView extends GridView{
	 ...
	 */
	private int mDownScrollBorder = 0;
	
	/**
	 * DragGridView自动向上滚动的边界值
	 */
	private int mUpScrollBorder = 0;
...
//			Log.v("哈哈哈哈", "mDragPosition--------------"+mDragPosition);
...
//			Log.v("哈哈哈哈", "tempPosition--------------"+tempPosition);
