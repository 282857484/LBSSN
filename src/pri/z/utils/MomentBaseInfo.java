...
public class MomentBaseInfo implements Serializable{
	...
	public int MomentId = 0;//一个自增长的数列
	public String MessageId = "0";//存在百度上的动态id  //唯一
	public String UserId = "0";//发表动态的用户Id
	public String UserName = "0";//发表动态的用户昵称
	public String UploadTime = "0";//发表时间
	public String MomentContent = "0";//动态内容
	public String PraiseNum = "0";//赞的数量
	public String CritizenNum = "0";//踩的数量
	public String MyUserId = "0";//评论人的useid
	public String MyUserName = "0";//评论人的username
	public String HasOrNo = "0";//存放评论内容（0905）
	//是否已经加载赞或者踩：赞为1.踩为-1.0为没有赞或者踩
	
	public String Location = "0";//位置 [12.1212,12.121233]
	public String Sex = "0";///性别：1-男     2-女
	public String Age = "0";//年龄
	//0819后面加的
	public String ShowPhotos = "0";
