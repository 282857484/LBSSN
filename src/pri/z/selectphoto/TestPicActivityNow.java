...
public class TestPicActivityNow extends Activity {
	...
	private void initView() {
		...
		adapter = new ImageBucketAdapter(TestPicActivityNow.this, dataList);
		...
		gridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(TestPicActivityNow.this,
						ImageGridActivityNow.class);
				List<ImageItem> lists = dataList.get(position).imageList;
				//倒序
//				Collections.reverse(lists);
				intent.putExtra(TestPicActivityNow.EXTRA_IMAGE_LIST,
						(Serializable)lists);
