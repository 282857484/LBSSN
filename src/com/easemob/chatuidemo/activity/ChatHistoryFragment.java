...
public class ChatHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		// contact list
		contactList = SEMapApplication.getInstance().getContactList();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (adapter.getItem(position).getUsername().equals(SEMapApplication.getInstance().getUserName()))
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), R.layout.hx_row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
