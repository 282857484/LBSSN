...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Drawable referenceDrawable = getResources().getDrawable(R.drawable.hx_smiley_add_btn);
		...
		adapter = new GridAdapter(this, R.layout.hx_grid, group.getMembers());
	...
	private class GridAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			if (position == getCount() - 1) {
				button.setText("");
				// 设置成删除按钮
				button.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.hx_smiley_minus_btn, 0, 0);
				...
				button.setText("");
				button.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.hx_smiley_add_btn, 0, 0);
				// 如果不是创建者或者没有相应权限
				...
				Drawable avatar = getResources().getDrawable(R.drawable.hx_default_avatar);
