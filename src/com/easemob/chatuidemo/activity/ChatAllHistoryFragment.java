...
import pri.z.show.ActivityLocal;
import pri.z.show.R;
...
public class ChatAllHistoryFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (username.equals(SEMapApplication.getInstance().getUserName()))
		...
		TextView tvSetting = (TextView) getView().findViewById(R.id.z_hx_chatSettingTv);
		...
		TextView tvContacts = (TextView) getView().findViewById(R.id.z_hx_chatContactsTv);
		tvContacts.setOnClickListener(new OnClickListener() {
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(R.menu.hx_delete_message, menu);
		// }
	}
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.delete_message) {
			...
			// 更新消息未读数
			((MainActivityHX) getActivity()).updateUnreadLabel();
	...
	public void onResume() {
		super.onResume();
		if (!hidden && ! ((MainActivityHX)getActivity()).isConflict) {
			refresh();
		}
	}
