...
public class AddContactActivity extends BaseActivity{
	...
	public void addContact(View view){
		if(SEMapApplication.getInstance().getUserName().equals(nameText.getText().toString())){
			startActivity(new Intent(this, AlertDialog.class).putExtra("msg", "不能添加自己"));
			return;
		}
		
		if(SEMapApplication.getInstance().getContactList().containsKey(nameText.getText().toString())){
