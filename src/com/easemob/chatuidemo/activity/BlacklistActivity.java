...
public class BlacklistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hx_activity_black_list);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getMenuInflater().inflate(R.menu.hx_remove_from_blacklist, menu);
	}
	...
	private class BlacklistAdapater extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = View.inflate(getContext(), R.layout.hx_row_contact, null);
			}
