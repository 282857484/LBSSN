...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.drawable.hx_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(R.layout.hx_image_grid_fragment,
				container, false);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(R.layout.hx_choose_griditem, container,false);
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.drawable.hx_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(R.drawable.hx_empty_photo);
