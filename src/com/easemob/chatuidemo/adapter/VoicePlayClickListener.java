...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.hx_chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(R.drawable.hx_chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	private void showAnimation() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.anim.hx_voice_from_icon);
		} else {
			voiceIconView.setImageResource(R.anim.hx_voice_to_icon);
		}
