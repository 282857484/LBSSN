...
public class ChatHistoryAdapter extends ArrayAdapter<EMContact> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.hx_row_chat_history, parent, false);
		}
		...
		if(position%2==0)
		{
			holder.list_item_layout.setBackgroundResource(R.drawable.hx_mm_listitem);
		}else{
			holder.list_item_layout.setBackgroundResource(R.drawable.hx_mm_listitem_grey);
		}
		...
		if(user instanceof EMGroup){
			//群聊消息，显示群聊头像
			holder.avatar.setImageResource(R.drawable.hx_group_icon);
		}else{
			holder.avatar.setImageResource(R.drawable.hx_default_avatar);
		}
