...
/**
 * 图片加载类
 * 用在用户发表动态含有图片的图片中，就算没有网络来的图片，也不显示默认的图片
 */
public class ImageManager4 {

	private static ImageManager4 imageManager;
	 ...
	 * @return
	 */
	public static ImageManager4 from(Context context) {
		...
		if (imageManager == null) {
			imageManager = new ImageManager4(myapp);
		}
	 ...
	 * @param context
	 */
	private ImageManager4(Context context) {
