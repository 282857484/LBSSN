 ...
 *
 */
public class UserInfoSelectData implements Serializable{

	@Override
	public String toString() {
		return "UserInfoSelectData [UserID=" + UserID + ", UserName="
				+ UserName + ", UploadTime=" + UploadTime + ", Code=" + Code
				+ ", UserPhone=" + UserPhone + ", UserJoinActivity="
				+ UserJoinActivity + ", UserAttentionClass="
				+ UserAttentionClass + ", UserQQ=" + UserQQ + ", UserWeiChat="
				+ UserWeiChat + ", UserTags=" + UserTags + ", UserClass="
				+ UserClass + ", UserDescribe=" + UserDescribe + ", UserLevel="
				+ UserLevel + ", UserLogo=" + UserLogo + ", UserAge=" + UserAge
				+ ", UserSex=" + UserSex + ", School=" + School
				+ ", Profession=" + Profession + ", Birthday=" + Birthday
				+ ", Home=" + Home + "]";
	}
