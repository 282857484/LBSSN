 ...
 * 
 */
public class ActivityDiscussSelectData implements Serializable{
	...
	public String toString() {
		return "ActivityDiscussSelectData [DiscussID=" + DiscussID
				+ ", ActivityID=" + ActivityID + ", UserID=" + UserID
				+ ", PointDiscussID=" + PointDiscussID + ", ThisUserID="
				+ ThisUserID + ", UploadTime=" + UploadTime + ", ActivityName="
				+ ActivityName + ", UserName=" + UserName + ", DiscussContent="
				+ DiscussContent + ", Photo=" + Photo + "]";
	}
