...
public class ActivitySelectData {
	...
	private String ActivityBelongClass = "0";//主办单位
	...
	public String toString() {
		return "ActivitySelectData [ActivityID=" + ActivityID
				+ ", BuildActivityUserID=" + BuildActivityUserID
				+ ", ActivityManagerID=" + ActivityManagerID + ", UploadTime="
				+ UploadTime + ", IsDirectJoinIn=" + IsDirectJoinIn
				+ ", ActivityFlag=" + ActivityFlag + ", ActivityMemberNumber="
				+ ActivityMemberNumber + ", ActivityMaxMemberNumber="
				+ ActivityMaxMemberNumber + ", ActivityDescribe="
				+ ActivityDescribe + ", ActivityName=" + ActivityName
				+ ", ActivityStartTime=" + ActivityStartTime
				+ ", ActivityEndTime=" + ActivityEndTime
				+ ", ActivityHoldPlace=" + ActivityHoldPlace + ", HelpPhone="
				+ HelpPhone + ", ActivityBelongClass=" + ActivityBelongClass
				+ ", ActivityTags=" + ActivityTags + ", ActivityOpinion="
				+ ActivityOpinion + ", ActivityAddress=" + ActivityAddress
				+ ", ActivityLogo=" + ActivityLogo + "]";
	}
